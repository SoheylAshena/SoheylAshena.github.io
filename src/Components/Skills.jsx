...
function Skills({ data }) {
  return (
    <div className="container px-6 py-20" id="skills">
      ...
      >
        <h2 className="bg-gradient-to-r from-pink-500 to-purple-600 bg-clip-text text-6xl font-bold text-transparent">
          My Skills
        </h2>
      ...
      >
        {data.skills.skill.map((item, index) => (
          ...
          >
            ...
            />
            {/* Skill Name */}
            <p className="text-lg font-semibold tracking-wide text-gray-200 transition-colors duration-300 group-hover:text-pink-500 dark:text-gray-100">
              {item.name}
            </p>
          </motion.div>
        ))}
      ...
      {/* Section Description */}
      <motion.p
        className="mx-auto mt-12 max-w-3xl text-center text-lg text-gray-400 dark:text-gray-300"
